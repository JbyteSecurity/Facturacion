<?php
    ...
    $active_boletas="active";
    $active_facturas="";
	$active_productos="";
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Boleta | Simple Invoice";
	...
	if (isset($_GET['id_boleta']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.email_cliente, boletas.id_vendedor, boletas.fecha_boleta, boletas.condiciones, boletas.estado_boleta, boletas.numero_boleta";
		$sql_boleta=mysqli_query($con,"select $campos from boletas, clientes where boletas.id_cliente=clientes.id_cliente and id_boleta='".$id_boleta."'");
		$count=mysqli_num_rows($sql_boleta);
		if ($count==1)
		{
				$rw_boleta=mysqli_fetch_array($sql_boleta);
				$id_cliente=$rw_boleta['id_cliente'];
				$nombre_cliente=$rw_boleta['nombre_cliente'];
				$telefono_cliente=$rw_boleta['telefono_cliente'];
				$email_cliente=$rw_boleta['email_cliente'];
				$id_vendedor_db=$rw_boleta['id_vendedor'];
				$fecha_boleta=date("d/m/Y", strtotime($rw_boleta['fecha_boleta']));
				$condiciones=$rw_boleta['condiciones'];
				$estado_boleta=$rw_boleta['estado_boleta'];
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar Boleta</h4>
		</div>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_boleta">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="fecha" value="<?php echo $fecha_boleta;?>" readonly>
							</div>
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="estado_factura" name="estado_boleta">
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="button" class="btn btn-default" onclick="imprimir_boleta('<?php echo $id_boleta;?>')">
			...
			<div class="clearfix"></div>
				<div class="editar_boleta" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->	
	...
	<script type="text/javascript" src="js/editar_boleta.js"></script>
