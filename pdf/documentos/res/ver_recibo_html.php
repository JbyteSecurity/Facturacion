...
<?php
$sql=mysqli_query($con, "select count(*) as items from products, detalle_recibo, recibos where products.id_producto=detalle_recibo.id_producto and detalle_recibo.numero_recibo=recibos.numero_recibo and recibos.numero_recibo='".$numero_recibo."'");
$cantidad = 0;
