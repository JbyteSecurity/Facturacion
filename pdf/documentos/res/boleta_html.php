...
$insertcorrelativo = mysqli_query($con,"UPDATE correlativos set numero = $nuevo_numero where documento ='Boleta' ");	 
	...
	//Creamos Archivo txt
    $pdf = "10292356817-01-F002-".$numero_boleta;
	$ruc = "10292356817-01-F002-".$numero_boleta.".CAB";
	$date=date("Y-m-d");
	...
	$ruc2 = "10292356817-01-F002-".$numero_boleta.".DET";
	...
	$ruc3 = "10292356817-01-F002-".$numero_boleta.".ACA";
