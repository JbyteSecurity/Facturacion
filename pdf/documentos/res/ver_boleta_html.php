...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
			...
			BOLETA Nº <?php 
			$cantidad = strlen($numero_<style type="text/css">
<!--
table { vertical-align: top; }
tr    { vertical-align: top; }
td    { vertical-align: top; }
...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from products, detalle_boleta, boletas where products.id_producto=detalle_boleta.id_producto and detalle_boleta.numero_boleta=boletas.numero_boleta and boletas.id_boletas='".$id_boleta."'");
...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from products, detalle_boleta, boletas where products.id_producto=detalle_boleta.id_producto and detalle_boleta.numero_boleta=boletas.numero_nota and boletas.id_boleta='".$id_boleta."'");
