<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Nuevo Recibo | Simple Invoice";
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Nuevo Recibo Interno</h4>
		</div>
				...
				<div class="col-md-12">
					<div class="pull-right">
						<button type="button" class="btn btn-default" data-toggle="modal" data-target="#nuevoProducto">
						 <span class="glyphicon glyphicon-plus"></span> Agregrar Item
						</button>
	...
	<script type="text/javascript" src="js/nuevo_recibo.js"></script>	
