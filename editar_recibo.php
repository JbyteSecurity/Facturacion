<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Editar Recibo | Simple Invoice";
	...
	if (isset($_GET['id_recibo']))
	{
		...
		$campos="clientes.id_cliente, clientes.nombre_cliente, clientes.telefono_cliente, clientes.email_cliente, recibos.id_vendedor, recibos.fecha_recibo, recibos.condiciones, recibos.estado_recibo, recibos.numero_recibo";
		$sql_recibo=mysqli_query($con,"select $campos from recibos, clientes where recibos.id_cliente=clientes.id_cliente and id_recibo='".$id_recibo."'");
		$count=mysqli_num_rows($sql_recibo);
		if ($count==1)
		{
				$rw_recibo=mysqli_fetch_array($sql_recibo);
				$id_cliente=$rw_recibo['id_cliente'];
				$nombre_cliente=$rw_recibo['nombre_cliente'];
				$telefono_cliente=$rw_recibo['telefono_cliente'];
				$email_cliente=$rw_recibo['email_cliente'];
				$id_vendedor_db=$rw_recibo['id_vendedor'];
				$fecha_recibo=date("d/m/Y", strtotime($rw_recibo['fecha_recibo']));
				$condiciones=$rw_recibo['condiciones'];
				$estado_recibo=$rw_recibo['estado_recibo'];
				$numero_recibo=$rw_recibo['numero_recibo'];
				$_SESSION['id_recibo']=$id_recibo;
				$_SESSION['numero_recibo']=$numero_recibo;
		}	
		else
		{
  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> Editar recibo</h4>
		</div>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_recibo">
				  ...
				  <label for="tel1" class="col-md-1 control-label">Teléfono</label>
					...
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							...
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="fecha" value="<?php echo $fecha_recibo;?>" readonly>
							</div>
							...
							<div class="col-md-2">
								<select class='form-control input-sm ' id="estado_factura" name="estado_recibo">
				...
				<div class="col-md-12">
					<div class="pull-right">
						...
						<button type="button" class="btn btn-default" onclick="imprimir_recibo('<?php echo $id_recibo;?>')">
			...
			<div class="clearfix"></div>
				<div class="editar_recibo" class='col-md-12' style="margin-top:10px"></div><!-- Carga los datos ajax -->	
	...
	<script type="text/javascript" src="js/editar_recibo.js"></script>
