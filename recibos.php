			...
			<div class="panel-body">
				<form class="form-horizontal" role="form" id="datos_cotizacion">
						...
						<div class="form-group row">
							<label for="q" class="col-md-2 control-label">Cliente o # de Recibo Interno</label>
							<div class="col-md-5">
								<input type="text" class="form-control" id="q" placeholder="Nombre del cliente o # de Recibo Interno" onkeyup='load(1);'>
							</div>
